...
import hyper_ledger.ledger.merkle_tree as merkle_tree
...
from hyper_ledger.ledger.util import ConsistencyVerificationFailed
from hyper_ledger.ledger.util import count_bits_set, lowest_bit_set
