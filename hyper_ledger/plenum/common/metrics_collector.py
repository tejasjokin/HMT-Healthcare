...
class MetricsName(IntEnum):
    ...
    PROPAGATES_PHASE_REQ_TIMEOUTS = 75
    ORDERING_PHASE_REQ_TIMEOUTS = 76
    AUTH_RULES_FROM_STATE_COUNT = 77
    ...
    # Stashed
    REPLICA_STASHED_CATCHUP_MASTER = TMP_METRIC + 2029
    REPLICA_STASHED_FUTURE_VIEW_MASTER = TMP_METRIC + 2030
    REPLICA_STASHED_WATERMARKS_MASTER = TMP_METRIC + 2031

    REPLICA_STASHED_CATCHUP_BACKUP = TMP_METRIC + 2032
    REPLICA_STASHED_FUTURE_VIEW_BACKUP = TMP_METRIC + 2033
    REPLICA_STASHED_WATERMARKS_BACKUP = TMP_METRIC + 2034
